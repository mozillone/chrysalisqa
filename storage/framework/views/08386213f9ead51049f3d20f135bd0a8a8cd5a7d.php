...
<p><span class="ctume_tip-spn">Tip:</span>What makes your costume unique? Describe it with keywords to help buyers find it. </p><span class="req-field" ></span></label>
									...
									<input id="input_1" name="keyword_1" value="" type="hidden">
								 	...
								 	<?php if(!empty($cos_data->cos_keywords)): ?>
											...
											<div id="count"><?php if(!empty($cos_data->cos_keywords)): ?><?php echo e(10 - count($explode)); ?> left <?php else: ?> 10 left <?php endif; ?> </div>
													</div>
												...
												<?php if(!empty($faq_value_value->attribute_option_value)): ?>
	...
	<div class="form-group has-feedback" >
		...
		<div class="input-group plus_minus_div">
			...
			<p class="form-rms-rel111">
				<div class="input-group ">
			         <span class="input-group-btn">
			          ...
			          <input type="text" name="donate_charity" id="donate_charity" class="form-control input-number chr_bt1" value="<?php echo e($cos_data->donation_percent); ?>" >
			          <span class="input-group-btn">
			...
			<p class="cst3-textl2 d-amount"  id="dynamic_percent_amounts"><i class="fa fa-usd" aria-hidden="true"></i><?php echo e($cos_data->donation_amount); ?></p>
			<input type="hidden" name="hidden_donation_amount" id="hidden_donation_amounts" value="<?php echo e($cos_data->donation_amount); ?>">
			<p class="error"><?php echo e($errors->first('donate_charity')); ?></p>
