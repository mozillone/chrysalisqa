						...
						<div class="col-md-6">
							...
							<div class="col-md-12">
									...
									<div class="input-group">
										<input type="text" class="form-control" placeholder="Username"  name="user_name" id="user_name" value="<?php echo e($user->display_name); ?>">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="fileupload fileupload-new" data-provides="fileupload"> 
										<img  <?php if(empty($user->user_img)): ?> src="<?php echo e(asset('/img/default.png')); ?>" <?php else: ?> src="/profile_img/<?php echo e($user->user_img); ?>" <?php endif; ?> class="img-pview img-responsive img-circle pic" id="img-chan" name="img-chan">
