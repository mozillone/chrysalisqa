...
<p class="form-rms-dim form-rms-he"><?php echo ucfirst($heading); ?> <br/> <span class="form-rms-he1">
 <input type="<?php echo e($bodyanddimensions->code); ?>" name="<?php echo e($body_height_ft->value); ?>" id="<?php echo e($body_height_ft->value); ?>"> <span><?php echo $heading_value;?></span>
 <input type="<?php echo e($bodyanddimensions->code); ?>" class="form-rms-dt" name="<?php echo e($body_height_in->value); ?>" id="<?php echo e($body_height_in->value); ?>" > <span><?php echo $heading_value_in; ?></span></span></p>
<p class="form-rms-dim weight-chest"><?php echo ucfirst($heading_weight_value); ?> <br/> <span class="form-rms-he1"><input type="text" name="<?php echo e($body_weight_lbs->value); ?>" id="<?php echo e($body_weight_lbs->value); ?>"> <span><?php echo $heading_weight_value_lbs;?></span></span></p>
<p class="form-rms-dim weight-chest"><?php echo ucfirst($heading_chest_value); ?> <br/> <span class="form-rms-he1"><input type="text" name="<?php echo e($body_chest_in->value); ?>" id="<?php echo e($body_chest_in->value); ?>" > <span><?php echo $heading_chest_value_in; ?> </span></span></p>
<p class="form-rms-dim weight-chest"><?php echo ucfirst($heading_waist_value); ?> <br/> <span class="form-rms-he1"><input type="text" name="<?php echo e($body_waist_lbs->value); ?>" id="<?php echo e($body_waist_lbs->value); ?>"> <span><?php echo $heading_waist_value_lbs; ?></span></span></p>
...
<span class="full-rms"><input type="<?php echo e($cosplayone->type); ?>" name="<?php echo e($cosplayone->code); ?>" id="<?php echo e($cosplayone_val->optionid); ?>" value="<?php echo e($cosplayone_val->optionid); ?>"> <?php echo e($cosplayone_val->value); ?></span>
<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
</p>
...
<span class="full-rms"><input type="<?php echo e($cosplaytwo->type); ?>" name="<?php echo e($cosplaytwo->code); ?>" id="<?php echo e($cosplaytwo_val->optionid); ?>" value="<?php echo e($cosplaytwo_val->optionid); ?>"> <?php echo e($cosplaytwo_val->value); ?></span>
<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
</p>
...
<span class="full-rms"><input type="<?php echo e($cosplaythree->type); ?>" name="<?php echo e($cosplaythree->code); ?>" id="<?php echo e($cosplaythree_val->optionid); ?>" value="<?php echo e($cosplaythree_val->optionid); ?>"> <?php echo e($cosplaythree_val->value); ?></span>
<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
</p>
...
<span class="full-rms"><input type="<?php echo e($cosplayfour->type); ?>" name="<?php echo e($cosplayfour->code); ?>" id="<?php echo e($cosplayfour_val->optionid); ?>" value="<?php echo e($cosplayfour_val->optionid); ?>"> <?php echo e($cosplayfour_val->value); ?></span>
<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
...
<span class="full-rms"><input type="<?php echo e($cosplayfive->type); ?>" name="<?php echo e($cosplayfive->code); ?>" id="<?php echo e($cosplayfive_val->optionid); ?>" value="<?php echo e($cosplayfive_val->optionid); ?>"> <?php echo e($cosplayfive_val->value); ?></span>
<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
</p>
...
<option value="<?php echo e($shipping->optionid); ?>"><?php echo e(ucfirst($shipping->value)); ?></option>
<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
...
<option value="<?php echo e($type->optionid); ?>" name="type"><?php echo e($type->value); ?></option>
<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
</select>
</p>
...
?>
<option value="<?php echo e($service->optionid); ?>" name="service"><?php echo e(ucfirst($str)); ?></option>
...
<p><?php echo e($charity->name); ?></p><input type="radio" id="<?php echo e($charity->name); ?>" value="<?php echo e($charity->id); ?>" name="charity_name" /></li>
<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
</ul>
...
$('#donate_charity').change(function(){
	...
	$('#costume_description_next').click(function(a){
		...
		if (str == true) {
			/*$.ajax({
			 url: "<?php echo e(URL::to('costume/costumedescription')); ?>",
			 type: "POST",
    ...
    if (service == "") {
      ...
      str=false;
		...
		if (str == true) {
			/*$.ajax({
			 url: "<?php echo e(URL::to('costume/costumepricing')); ?>",
			 type: "POST",
	...
	$('#preferences_finished').click(function(a){
		...
		if (str == true) {
			...
			$('.loader-align').append('<img id="ajax_loader" src="<?php echo e(asset("img/ajax-loader.gif")); ?>" >');
			$.ajax({
			 url: "<?php echo e(URL::to('costume/costumecreate')); ?>",
			 type: "POST",
