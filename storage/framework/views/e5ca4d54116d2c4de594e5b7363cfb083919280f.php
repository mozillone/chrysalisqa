			...
			<div class="col-md-12 col-sm-12 col-xs-12">
										...
										<div class="drop_uploader drop_zone drop_zone1">
											...
											<ul class="files thumb">
												<li id="selected_file_0">
													<div class="thumbnail" style="background-image: url('<?php echo e(asset('costumers_images/Medium')); ?><?php echo '/'.$front_image->image; ?>');position: absolute;top:-10px !important;">
													</div>
												</li>
											</ul>
										</div>
										<input type="hidden" name="Imagecrop1" data-id ="<?php echo e($front_image->image); ?>" data-value="1" class="Forntview" value="">
										<?php 
										}else { ?>
										<input type="file" name="file1" accept="image/*" value="1" id="file1">
										...
										<div class="drop_uploader drop_zone drop_zone2">
											...
											<ul class="files thumb">
												<li id="selected_file_1">
													<div class="thumbnail" style="background-image: url('<?php echo e(asset('costumers_images/Medium')); ?><?php echo '/'.$back_image->image; ?>');position: absolute;top:-10px !important;"></div>
												</li>
											</ul>
										</div>
										<input type="hidden" name="Imagecrop2" data-id ="<?php echo e($back_image->image); ?>" data-value="2" class="Backview" value="">
										<?php 
										}else { ?>
										<input type="file" name="file2" accept="image/*" id="file2" value="1">
										...
										<div class="drop_uploader drop_zone drop_zone3">
											...
											<ul class="files thumb">
												<li id="selected_file_2">
													<div class="thumbnail" style="background-image: url('<?php echo e(asset('costumers_images/Medium')); ?><?php echo '/'.$details_image->image; ?>');position: absolute;top:-10px !important;">
													</div>
												</li>
											</ul>
										</div>
										<input type="hidden" name="Imagecrop3" data-id ="<?php echo e($details_image->image); ?>" data-value="3" class="Additional" value="">
										<?php 
										}else { ?>
										<input type="file" name="file3" accept="image/*" id="file3" value="1">
								...
								<div class="col-md-12 col-sm-12 col-xs-12 ">
									...
									<div class="row multi_main_div">
										...
										<div class="col-md-4 col-sm-4 col-xs-12 multi_div" id="remv_<?php echo e($i); ?>">
											<input type="hidden" name="hidden_file4[]" id="remv_<?php echo e($i); ?>" class="hiddenValue" data-id = "<?php echo e($image->image); ?>" value="<?php echo e($image->image); ?>">
							...
							<div class="col-md-12 col-xs-12 col-sm-12 ">
								...
								<div class="form-rms">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<p class="form-rms-input"><input type="text" name="costume_name" value="<?php echo e($costume_description->name); ?>" id="costume_name" autocomplete="off" tab-index="1" placeholder="Example : Dark Knight Joker Cosplay"></p>
								...
								<div class="form-rms">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<p class="form-rms-input">
											...
											<?php if(count($db_subcategoryname)>0 &&!empty($db_subcategoryname)): ?>
											<select name="subcategory" id="subcategory" class="form-control">
												...
												<?php if(!empty($costume_category_2->category_id)): ?>
								...
								<?php if($costume_details->size == "custom"): ?>
								<div class="form-rms body-dimnets">
									<div class="col-md-4 col-sm-4 col-xs-12 pdlft0">
										<p class="form-rms-que"><?php echo e($bodyanddimensions->label); ?> *</p>
									</div>
									<div class="col-md-8 col-sm-8 col-xs-12">
										<div class="form-rms-input">
											<?php
											...
											<p class="form-rms-dim form-rms-he"><?php echo ucfirst($heading); ?> <br/> 
												<span class="form-rms-he1">
													<input type="<?php echo e($bodyanddimensions->code); ?>" name="<?php echo e($body_height_ft->value); ?>" id="<?php echo e($body_height_ft->value); ?>" value="<?php echo e($db_body_height_ft->attribute_option_value); ?>"> <span><?php echo $heading_value;?></span>
													<input type="<?php echo e($bodyanddimensions->code); ?>" class="form-rms-dt" name="<?php echo e($body_height_in->value); ?>" id="<?php echo e($body_height_in->value); ?>" value="<?php echo e($db_body_height_in->attribute_option_value); ?>"> <span><?php echo $heading_value_in; ?></span>
													<span id="heighterror" style="color:red"></span>
												</span>
											</p>
											<p class="form-rms-dim weight-chest"><?php echo ucfirst($heading_weight_value); ?> <br/> 
												<span class="form-rms-he1">
													<input type="text" name="<?php echo e($body_weight_lbs->value); ?>" id="<?php echo e($body_weight_lbs->value); ?>" value="<?php echo e($db_body_weight_lbs->attribute_option_value); ?>"> <span><?php echo $heading_weight_value_lbs;?></span>
												<span id="weighterror" style="color:red"></span>
											</span></p>
											<p class="form-rms-dim weight-chest"><?php echo ucfirst($heading_chest_value); ?> <br/> 
												<span class="form-rms-he1">
													<input type="text" name="<?php echo e($body_chest_in->value); ?>" id="<?php echo e($body_chest_in->value); ?>" value="<?php echo e($db_body_chest_in->attribute_option_value); ?>" > <span><?php echo $heading_chest_value_in; ?> </span>
													<span id="chesterror" style="color:red"></span>
												</span>
											</p>
											<p class="form-rms-dim weight-chest"><?php echo ucfirst($heading_waist_value); ?> <br/> 
												<span class="form-rms-he1">
													<input type="text" name="waist-inches" id="waist-inches" value="<?php echo e($db_body_waist_lbs->attribute_option_value); ?>"> <span>in</span>
								...
								<div class="form-rms film_quality_div">
									...
									<div class="col-md-8 col-sm-8 col-xs-12 pdlft0">
										<p class="form-rms-input">
											...
											<?php $__currentLoopData = $cosplayfive_values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cosplayfive_val): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
											 
											<div class="col-md-2  col-sm-4">
												<input id="<?php echo e($cosplayfive_val->optionid); ?>" <?php if($db_cosplayfive->attribute_option_value_id == $cosplayfive_val->optionid) { ?> checked="checked" <?php } ?> value="<?php echo e($cosplayfive_val->optionid); ?>" class="radio-custom faq-checkbox" name="<?php echo e($cosplayfive->code); ?>" type="radio" value="<?php echo e($cosplayfive_val->optionid); ?>">
										...
										<p class="form-rms-small" id="film_text" <?php if(count($db_film_name)!= 1): ?> style="display: none;" <?php endif; ?> >Was it Used in a Production? Which One?</p>
				...
				<div class="col-md-8 col-sm-8 pdlft0 how_lng_tme">
					...
					<span class="full-rms">
						...
						<input id="<?php echo e($cosplayfour_val->optionid); ?>" class="radio-custom faq-checkbox" name="<?php echo e($cosplayfour->code); ?>" <?php if($db_cosplayfour->attribute_option_value_id == $cosplayfour_val->optionid) { ?> checked="checked" <?php } ?> type="<?php echo e($cosplayfour->type); ?>" value="<?php echo e($cosplayfour_val->optionid); ?>">
					...
					<?php if(count($db_make_costume_time)== 1): ?>
						...
						<p class="col-md-4  col-sm-6" id="mention_hours" <?php if(count($db_make_costume_time)!= 1): ?> style="display: none;" <?php endif; ?> >How long did it take?</p>
						<p class="col-md-8" id="mention_hours_input" <?php if(count($db_make_costume_time)!= 1): ?> style="display: none;" <?php endif; ?>><input type="text" name="make_costume_time" id="make_costume_time1" value="<?php echo e($db_make_costume_time->attribute_option_value); ?>" class="input-rm100"> <span><i>hours</i><span><span id="usercostumeerror" style="color:red"></span>
                        </div>
					</p>
					<?php else: ?>
					...
					<?php endif; ?>
								...
								<div class="form-rms descibr_smte_text">
									...
									<?php if(!empty($costume_description->keywords)): ?>
										...
										<div id="count"><?php if(!empty($costume_description->keywords)): ?><?php echo e(10 - count($explode)); ?> left <?php else: ?> 10 left <?php endif; ?> </div>
...
" name="description" id="description" maxlength="600" ><?php echo e($db_des_costume->attribute_option_value); ?></textarea></p>
						<span id="descriptionerror" style="color:red"></span>
						<p class="form-rms-sm1 max_lnths1 max-edit2">( <span id="max_length_char1"></span> 600 characters)</p>
						</div>
				</div>				

				<?php if(!empty($db_faq->attribute_option_value)): ?>
				<div class="form-rms" id="freqently">
					...
					<div class="col-md-8 col-sm-8 col-xs-12">
						<p class="form-rms-input">
						<textarea placeholder="Please be as detailed as possible!" name="faq" id="faq" maxlength="600" ><?php echo e($db_faq->attribute_option_value); ?></textarea></p>
								...
								<div class="form-rms">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<div class="form-rms-input dimensions-two dimensions-two-pk_info">
											<p class="form-rms-dim"><span class="form-rms-he1"><input id="pounds" name="pounds" value="<?php echo e($costume_details->weight_pounds); ?>" type="text" placeholder="0"> <span>lbs</span></span></p>
											<span id="poundserror" style="color:red"></span>
											<p class="form-rms-dim"><span class="form-rms-he1"><input id="ounces" name="ounces" value="<?php echo e($costume_details->weight_ounces); ?>" type="text" placeholder="0"> <span>oz </span></span></p>
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="form-rms">
								...
								<div class="col-md-8 col-sm-8 col-xs-12 return_divs">
									<p class="form-rms-input">
									<?php if(isset($db_return) && !empty($db_return)): ?>
                                    <?php $__currentLoopData = $returnpolicy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$returnpolicy): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                        ...
                                        <input id="<?php echo e($returnpolicy->optionid); ?>" class="radio-custom" name="returnpolicy" <?php if($db_return->attribute_option_value_id == $returnpolicy->optionid) { ?> checked="checked" <?php } ?>  type="radio" value="<?php echo e($returnpolicy->optionid); ?>">
										...
										<div class="form-rms-input plus_minus_div">
                                            ...
                                            <div class="col-md-3">
	                                            <div class="input-group">
	                                            	...
	                                            	<input type="text" name="donate_charity" class="form-control input-number" id="donate_charity" value="<?php echo e($costume_details->dynamic_percent); ?>" min="0" max="100">
		                                            <span class="input-group-btn">
...
<?php echo e(number_format($costume_details->donation_amount, 2)); ?></p>
												<input type="hidden" name="hidden_donation_amount" id="hidden_donation_amounts" value="<?php echo e($costume_details->donation_amount); ?>">
									...
									<div class="col-md-12 col-sm-12 col-xs-12 pdlft0">
										<ul class="ct3-list">
											...
											<?php $__currentLoopData = $charities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$charity): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
												<li>
													<img class="img-responsive" src="<?php if(isset($charity->image) && !empty($charity->image)): ?><?php echo e(URL::asset('/charities_images/')); ?>/<?php echo e($charity->image); ?> <?php else: ?> <?php echo e(URL::asset('/img/default.png')); ?> <?php endif; ?>" alt="<?php echo e($charity->name); ?>" />
										...
										<!--<p class="cst2-rms-chck"><input type="checkbox" id="another_charity" name="another_charity" <?php if($costume_details->charity_id == 0 && $costume_details->dynamic_percent != "none"): ?> checked="checked" <?php endif; ?> >Want to suggest a favorite charity organization </p>-->
									</div>
								</div>
								<div class="form-rms" id="other_organzation_check" <?php if($costume_details->charity_id != 0 || $costume_details->dynamic_percent == "none" ): ?>style="display: block;" <?php endif; ?>>
								<p class="ct3-rms-head chartiy_spcy col-md-3 col-sm-3 col-xs-12">Want to suggest a favorite charity
									...
									<p class="org_nme col-md-9 col-sm-9 col-xs-12 orginze_input"><input type="text" value="<?php if(isset($charities_details) && !empty($charities_details)): ?><?php echo e($charities_details->name); ?><?php endif; ?>" name="organzation_name" id="organzation_name" autocomplete="off" placeholder="Organization Name"  class="form-control"></p>
                        ...
                        <div class="col-md-12">
                            <div class="row1">
                                ...
                                <h2>Congrats!</h2>
                                        ...
                                        <ul class="social-network social-circle">
                                            ...
                                            <!-- <li>
                                            	<a href="javascript:void(0);" class="icoTwitter" title="Instagram">
                                            		<img class="img-responsive" src="<?php echo e(URL::asset('assets/frontend/img/insta_ic.png')); ?>">
                                            	</a>
                                            </li> -->
                                            <li>
                                    ...
                                    <!-- <a type="button" id="" href="<?php echo e(URL::to('/')); ?>" class="btn-rm-ret">Share!</a><br> -->
