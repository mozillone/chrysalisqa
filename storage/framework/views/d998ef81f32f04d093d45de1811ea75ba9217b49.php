			...
			<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="col-md-12 col-xs-12 col-sm-12 ">
								...
								<div class="form-rms">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<p class="form-rms-input"><input type="text" name="costume_name" value="<?php echo e($costume_description->name); ?>" id="costume_name" autocomplete="off" tab-index="1" placeholder="Dark Knight Joker Cosplay"></p>
								...
								<div class="form-rms film_quality_div">
									...
									<div class="col-md-8 col-sm-8 col-xs-12 pdlft0">
										<p class="form-rms-input">
											...
											<div class="col-md-2  col-sm-4">
												<input id="<?php echo e($cosplayfive_val->optionid); ?>" <?php if($db_cosplayfive->attribute_option_value_id == $cosplayfive_val->optionid) { ?> checked="checked" <?php } ?> value="<?php echo e($cosplayfive_val->optionid); ?>" class="radio-custom" name="<?php echo e($cosplayfive->code); ?>" type="radio" value="<?php echo e($cosplayfive_val->optionid); ?>">
				...
				<div class="col-md-8 col-sm-8 pdlft0 how_lng_tme">
					...
					<span class="full-rms">
						...
						<input id="<?php echo e($cosplayfour_val->optionid); ?>" class="radio-custom" name="<?php echo e($cosplayfour->code); ?>" <?php if($db_cosplayfour->attribute_option_value_id == $cosplayfour_val->optionid) { ?> checked="checked" <?php } ?> type="<?php echo e($cosplayfour->type); ?>" value="<?php echo e($cosplayfour_val->optionid); ?>">
					...
					<?php if(count($db_make_costume_time)== 1): ?>
						...
						<p class="col-md-8" id="mention_hours_input" <?php if(count($db_make_costume_time)!= 1): ?> style="display: none;" <?php endif; ?>><input type="text" name="make_costume_time" id="make_costume_time1" value="<?php echo e($db_make_costume_time->attribute_option_value); ?>" class="input-rm100"> <span><i>hours</i><span>
                        </div>
					</p>
					<?php else: ?>
								...
								<div class="form-rms lst-stp">
									...
									<div class="col-md-8 col-sm-8 col-xs-12 dnt-amcnts">
										...
										<div class="form-rms-input plus_minus_div">
                                            ...
                                            <input type="text" name="donate_charity" class="form-control input-number" id="donate_charity" value="<?php echo e($costume_details->dynamic_percent); ?>" min="0" max="100"><i class="fa fa-percent" aria-hidden="true"></i>
                                            <span class="input-group-btn">
