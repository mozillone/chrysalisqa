							...
							<div class="col-md-3 col-sm-4 col-xs-6">
								<div class="prod_box">
									<div class="img_layer">
										...
										<div class="hover_box">
											<p class="like_fav">
												<a href="#" onclick="return false;" class="like_costume" data-costume-id="<?php echo e($costume->costume_id); ?>"><span><i aria-hidden="true" class="fa fa-thumbs-up"></i><?php echo e($costume->like_count); ?></span>
												</a> 
