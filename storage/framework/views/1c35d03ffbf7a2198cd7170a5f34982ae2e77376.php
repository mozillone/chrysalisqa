...
<?php $__env->startSection('content'); ?>
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo e(url('events-list')); ?>">Events</a>
            </li>
            ...
            <div class="col-sm-12 col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form id="events-create" class="form-horizontal defult-form" name="userForm" action="<?php echo e(route('insert-events')); ?>" method="POST" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-6 col-sm-4 col-xs-12 blog_status_right">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <p class="error"><?php echo e($errors->first('address1')); ?></p>
                                    </div>
                                    <div class="form-group has-feedback">
                                        ...
                                        <p class="error"><?php echo e($errors->first('address2')); ?></p>
                                    </div>
                                    <div class="form-group has-feedback">
                                        ...
                                        <p class="error"><?php echo e($errors->first('city')); ?></p>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group has-feedback">
                                                ...
                                                <select class="form-control" name="state" id="administrative_area_level_1">
                                                    ...
                                                    <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                                        <option value="<?php echo e($state->abbrev); ?>"><?php echo e($state->name); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                                </select>
                                                <p class="error"><?php echo e($errors->first('state')); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group has-feedback">
                                                ...
                                                <p class="error"><?php echo e($errors->first('zipcode')); ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group has-feedback">
                                    ...
                                    <div class="form-group has-feedback" >
                                        <div class="form-group <?php echo e($errors->has('profile_img') ? ' has-error' : ''); ?>" >
                                            ...
                                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                                ...
                                                <input type="hidden" class="name_img" class="find_img" value="<?php echo e(isset($user->profile_img) && ($user->profile_img!='default.jpg') ? $user->profile_img : 'default_pic.png'); ?>">
