					...
					<div class="row">
						...
						<div class="col-md-8 col-sm-12 col-xs-12 social-img">
							<div class="social-icons">
								<a target="_blank" href="https://www.facebook.com/Chrysalis-Costumes-1571674966183606/"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/fb-icon.png')); ?>"></a>
								<a target="_blank" href="https://twitter.com/MaxGarweg"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/twit-icon.png')); ?>"></a>
								<a target="_blank" href="https://www.instagram.com/chrysaliscostumes/?hl=en/"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/insta-icon.png')); ?>"></a>
								<a target="_blank" href=""><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/youtube-icon.png')); ?>"></a>
							</div>
						</div>
					</div>
				</div>
