					...
					<div class="row">
						...
						<div class="col-md-8 col-sm-12 col-xs-12 social-img">
							<div class="social-icons">
								<a href="https://www.facebook.com/Chrysalis-Costumes-1571674966183606/" target="_blank"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/fb-icon.png')); ?>"></a>
								<a href="https://twitter.com/MaxGarweg" target="_blank"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/twit-icon.png')); ?>"></a>
								<a href="https://www.instagram.com/chrysaliscostumes/?hl=en/" target="_blank"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/insta-icon.png')); ?>"></a>
								<a href="https://www.youtube.com/channel/UCZgeZrAV1UCoCXSWd75DNsw" target="_blank"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/youtube-icon.png')); ?>"></a>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="footer_links" id="footer-middle">
					<div class="col-md-4 col-sm-12 co-xs-12 ft-logo ">
						<div class="footer_head ">
							<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/brand.png')); ?>">
						...
						<div class="footer_head ">
							...
							<ul class="logo_ul">
								<div class="col-md-6 col-xs-6 col-sm-3 col-lg-6">
									<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/footer-mobile.png')); ?>">		
								</div>
								<div class="col-md-6 col-xs-6 col-sm-3 col-lg-6">
									...
									<a href="https://itunes.apple.com/in/app/the-chrysalis-app/id1270915543?mt=8">
										...
										<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/google-play.png')); ?>">
									</a>
								</div>
								</ul>
							</div>
					...
					<div class="login-register" id="loginModal">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active  in lgn" id="login_tab1">
								<form class="" action="<?php echo e(route('login.post')); ?>" method="POST" id="loginpopup">   
									<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
									<input type="hidden" name="costume_id" value="<?php if(!empty($data[0]->costume_id)): ?><?php echo e($data[0]->costume_id); ?><?php endif; ?>">
									<input type="hidden" name="is_cart" value="<?php if(!empty($data['basic'])): ?><?php echo e(count($data['basic'])); ?><?php endif; ?>">
							...
							<div class="tab-pane fade sign" id="signup_tab1">
								<form role="form" action="<?php echo e(route('register')); ?>" method="POST" id="signup_pop">
									<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
									<div class="form-group">
										<div class="form-group">
							...
							<div class="tab-pane fade fpswd" id="forget_password1">
								<form class="" action="<?php echo e(route('forgotpassword.post')); ?>" method="POST" id="forgetpopup_password">   
									<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
									<div class="form-group">
					...
					<div class="login-register" id="loginModal">
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active in" id="login_tab1">
								...
								<form class="" action="<?php echo e(route('login.post')); ?>" method="POST" id="loginpopup1">   
									<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
									<input type="hidden" name="costume_id" value="<?php if(!empty($data[0]->costume_id)): ?><?php echo e($data[0]->costume_id); ?><?php endif; ?>">
									<input type="hidden" name="is_cart" value="<?php if(!empty($data['basic'])): ?><?php echo e(count($data['basic'])); ?><?php endif; ?>">
									<div class="form-group">
				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active in" id="login_tab1">
							...
							<form class="" action="<?php echo e(route('forgotpassword.post')); ?>" method="POST" id="single_forgetpopup_password">   
								<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
								<div class="form-group">
					...
					<div class="login-register" id="loginModal">
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active in" id="login_tab1">
								...
								<form role="form" action="<?php echo e(route('register')); ?>" method="POST" id="signup_pop1">
									<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
									<div class="form-group">
										<div class="form-group">
											<label>Username<span style="color: red">*</span></label>
