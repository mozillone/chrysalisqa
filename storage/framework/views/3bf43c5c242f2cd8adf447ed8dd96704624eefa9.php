            ...
            <div class="box box-info">
             <div class="box-header">
  				  ...
  				  <ul class="nav nav-tabs">
					  ...
					  <li class="active"><a href="/user-costumessold-list/<?php echo e($userid); ?>">Costumes Sold</a></li>
...
<script src="<?php echo e(asset('angular/Admin/UserManagement/Controllers/soldorders-lists.js')); ?>"></script>
