...
<h3 class="box-title press_tle"><!--<?php $__env->startSection('heading'); ?><?php echo e($heading); ?><?php echo $__env->yieldSection(); ?>--></h3>
      <div class="box-tools pull-right">
              <a href="/create-job" type="button" class="btn btn-xs btn-block btn-success"><?php $__env->startSection('create'); ?>
           <?php echo e($create); ?>

       <?php echo $__env->yieldSection(); ?></a>
      </div>
    </div>
    <!-- /.box-header -->
    <div class="box-body ">
  ...
  <table class="table table-striped table-bordered user-list-table">
     ...
     <tbody>
        ...
        <tr>
           ...
           <td><input type="hidden" value="<?php echo e(Request::segment(4)); ?>" id="role_id" name="role_id">
...
var table = '';
  ...
  function changeStatus(id, status) {
        ...
        $.ajax({
            type: "GET",
            url: '<?php echo url('/admin/job/status'); ?>',
