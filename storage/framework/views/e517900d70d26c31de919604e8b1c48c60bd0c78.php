        ...
        <div class="col-sm-12 col-md-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <form id="category-create" class="form-horizontal defult-form" name="userForm" action="<?php echo e(route('categories-create')); ?>" method="POST" novalidate autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                      ...
                                      <div class="cat_img fileupload fileupload-new" data-provides="fileupload">
                                          <img src="<?php echo e(asset('/category_images/df_img.jpg')); ?>" class="img-responsive"  id="img-chan1">
                                            ...
                                            <div class=" upload_btns">
                                                      <span class=" btn-file">
                                                        ...
                                                        <div class="ban_img fileupload fileupload-new" data-provides="fileupload">
                                                            <img src="<?php echo e(asset('/category_images/df_img.jpg')); ?>" class="img-responsive"  id="img-chan2">
