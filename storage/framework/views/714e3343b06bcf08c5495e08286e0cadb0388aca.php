...
<table style="font-weight:normal;border-collapse:collapse;border:0;margin:0;padding:0;font-family:Arial,sans-serif;width:100%">
	...
	<h1 style="margin:10px 35px;color:#333;font-size:25px;font-weight:normal"><span class="sg-image"><img  src="<?php echo e(asset('assets/frontend/img/brand.png')); ?>" style="width: 206px;" /></span></h1>
			...
			<table style="width:100%;font-weight:normal;border-collapse:collapse;border:0;margin:0;padding:0;font-familfffffl,sans-serif;margin-top:0">
				<tbody>
					<tr>
						...
						<h1 style="color:#333;font-size:16px;font-weight:bold;line-height:24px">Hi <?php echo e($email['name']); ?>,<br />
						Welcome to Chrysalis.</h1>

						<div>Click <a href="<?php echo e($email['activation_link']); ?>">here</a> to activate your account</div>
						</td>
					</tr>
				</tbody>
			</table>
