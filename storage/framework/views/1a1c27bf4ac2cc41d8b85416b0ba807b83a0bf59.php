                ...
                <div class="panel-group" id="accordion">
                  				  ...
                  				  <div class="chek-out">
                                      ...
                                      <div class="form-group has-feedback selling_location_note" >
                                        ...
                                        <?php if(count($seller_address)): ?>  
                                          <input type="hidden" class="field form-control" name="add_id" value="<?php echo e($seller_address[0]->address_id); ?>">  
                  ...
                  <div class="panel panel-default">
                    ...
                    <div id="collapseThree" class="panel-collapse collapse">
                      <div class="panel-body">
                        <form class="" action="<?php echo e(route('search_banner')); ?>" method="POST" id="search_banner" autocomplete="off" enctype="multipart/form-data">
                          <div class="row">
                            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                            <div class="col-md-12">
                              <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                      <div class="ban_img fileupload fileupload-new" data-provides="fileupload">
                                        <img <?php if(file_exists( public_path('category_images/Banner/'.$search_banner_settings->file_name))): ?>) src="/category_images/Banner/<?php echo e($search_banner_settings->file_name); ?>" <?php else: ?>  src="/category_images/df_img.jpg" <?php endif; ?> class="img-responsive"  id="img-chan2">
