...
<div class="container">
	...
	<input type="hidden" name="key" value="<?php echo e($_GET['key']); ?>">
...
<div class="list-stl row price-range-slider">
	...
	<p class="list-sec-rm1">Search Results for "<?php echo e(ucfirst($_GET['key'])); ?>"</p>
...
<script src="<?php echo e(asset('/assets/frontend/js/pages/search_costumes_listing.js')); ?>"></script>
