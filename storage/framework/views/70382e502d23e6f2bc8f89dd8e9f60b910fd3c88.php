         ...
         <?php endif; ?>
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <a href="<?php echo e(route('attributes-create')); ?>" class="btn btn-block btn-success btn-xs"><i class="fa fa-plus"></i> Add Attributes</a>
                    </div>
                </div>
                <div class="box-body">
...
<script src="<?php echo e(asset('/angular/Admin/Attributes/Controllers/attributes-lists.js')); ?>"></script>
