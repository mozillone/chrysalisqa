			...
			<div id="main-banner" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/bnr-11.png')); ?>">
					</div>
					<div class="item">
						<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/bnr-22.png')); ?>">
					</div>
					<div class="item">
						<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/bnr-33.png')); ?>">
					</div>
				</div>
			...
			<div class="container">
				<div class="row  hidden-xs">
					<div class="col-md-8 col-sm-12 col-xs-12 jumb-bnr">
						<a href="#"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/bnr-11.png')); ?>"></a>
					</div>
					<div class="col-md-4 col-sm-4 col-xs-12 jumb-smll  hidden-xs hidden-sm">
						<a href="#"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/bnr-22.png')); ?>"></a>
						<a href="#"><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/bnr-33.png')); ?>"></a>
					</div>
				</div>
				...
				<div class="row home_steps hidden-xs">
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="media">
							<div class="media-left"> <a href="#"> <img alt="64x64" class="media-object" data-src="holder.js/64x64" src="<?php echo e(asset('/assets/frontend/img/step_1_icon.png')); ?>" data-holder-rendered="true" > </a>
							</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="media">
							<div class="media-left"> <a href="#"> <img alt="64x64" class="media-object" data-src="holder.js/64x64" src="<?php echo e(asset('/assets/frontend/img/step_2_icon.png')); ?>" data-holder-rendered="true" > </a>
							</div>
					...
					<div class="col-md-4 col-sm-4 col-xs-12">
						<div class="media">
							<div class="media-left"> <a href="#"> <img alt="64x64" class="media-object" data-src="holder.js/64x64" src="<?php echo e(asset('/assets/frontend/img/step_3_icon.png')); ?>" data-holder-rendered="true" > </a>
							</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="owl-carousel owl-theme">
						<div class="item">
							<div class="img_layer">
								<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/captain-1.png')); ?>">
							</div>
						...
						<div class="item">
							<div class="img_layer">
								<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/rey-1.png')); ?>">
							</div>
							<div class="slider_cnt">
								<h4>Captain Jack Sparrow,Pirates of The Carribean </h4>
								<p>$50.00</p>
						...
						<div class="item">
							<div class="img_layer">
								<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/wendy-1.png')); ?>">
							</div>
							<div class="slider_cnt">
								<h4>Captain Jack Sparrow,Pirates of The Carribean </h4>
								<p>$50.00</p>
						...
						<div class="item">
							<div class="img_layer">
								<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/jasmine-1.png')); ?>">
							</div>
							<div class="slider_cnt">
								<h4>Captain Jack Sparrow,Pirates of The Carribean </h4>
								<p>$50.00</p>
