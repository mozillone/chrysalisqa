...
<tr>
    <th style="color:#000; font-size:15px; padding:0px;"><h4 style="margin:20px auto 0px;">Hey, <?php echo e($order_info['seller_name']); ?>!</h4></th>
</tr>
<tr>
    <th style="color:#6a2b7c;"><h5 style="margin:0px auto 20px; padding:0px; font-size:22px;">You have a purchase request.</h5></th>
</tr>
<tr>
    <td style="color:#000;"><p style="margin:0px auto 20px; padding:0px; font-size:16px;"><span style="text-decoration:underline; color:#f53d68; font-style:italic;"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></span> would like to purchase your costume(s):</p></td>
</tr>
<tr>
    <td style="color:#000;">
     <?php $__currentLoopData = $order_info['items']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
        <h2 style="margin:0px auto 20px; padding:0px; font-size:25px; color:#f53d68; font-weight:bold; text-decoration:underline;"><?php echo e($items['costume_name']); ?></h2>
...
<table style="text-align:left;  padding:40px 40px 20px 40px; width:600px; margin:0px auto; font-family: 'Lato', 'Lucida Grande', 'Lucida Sans Unicode', Tahoma, Sans-Serif; background:url('https://image.ibb.co/dqaUdF/group_224.png') no-repeat -10px 60px; backgrouns-size:50px">
    <tbody>
    <tr>
        <td><p style="margin-bottom:0px;"><b>Hi <?php echo e($order_info['seller_name']); ?>,</b></p></td>
</tr>
    <tr>
    ...
    <tr>
        <td><p  style="margin-bottom:0px;">As soon as you ship out your product, please head over to Your <a href="<?php echo e(URL::to('/login')); ?>"><span style="color:#f53d68; text-decoration:underline">Account</span></a>  and mark your order as "shipped". You can find this under "Recent Orders".</p></td>
</tr>
    <tr>
...
<table style="text-align:center;  padding:20px 20px 40px 20px; width:500px; margin:0px auto; font-family: 'Lato', 'Lucida Grande', 'Lucida Sans Unicode', Tahoma, Sans-Serif;  border-top:1.5px solid #ddd;">
    <tr>
        <td style="border:2px solid #f53d68; font-weight:bold; width:50%;  padding:15px;color:#000; border-radius:5px; cursor:pointer;"><a href="<?php echo e(URL::to('/sold/order/'.$order_info['order_id'])); ?>" style="text-decoration: none; color:#000; border-radius:5px; cursor:pointer;">Decline</a></td>
        <td style="border:2px solid #f53d68; font-weight:bold; width:50%;  padding:15px; background:#f53d68; color:#fff; border-radius:5px; cursor:pointer;"><a href="<?php echo e(URL::to('/sold/order/'.$order_info['order_id'])); ?>" style="text-decoration: none; color:#fff; border-radius:5px; cursor:pointer;">Accept</a></td>
    </tr>
</table>
