						...
						<div class="row">
							...
							<div class="col-md-8 col-sm-12 col-xs-12 social-img">
								<div class="social-icons">
									<a href=""><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/fb-icon.png')); ?>"></a>
									<a href=""><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/twit-icon.png')); ?>"></a>
									<a href=""><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/insta-icon.png')); ?>"></a>
									<a href=""><img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/youtube-icon.png')); ?>"></a>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container">
				...
				<div class="footer_links" id="footer-middle">
					...
					<div class="footer_head ">
						...
						<img class="img-responsive" src="<?php echo e(asset('/assets/frontend/img/app-img.png')); ?>">
						</div>
						</div>
					</div>
					</div>
