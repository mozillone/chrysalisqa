<?php $__env->startSection('title'); ?> My Orders List @parent
...
<section class="container content-header view-order_tl_div">
				...
				<div class="box box-info costume-sold-sec">
					<div class="rencemt_order_table">
						...
						<div class="box-body">
							...
							<div class="table-responsive order_btm">
								<div class="table-responsive auto-scroll-none">
									<table datatable dt-options="dtOptions" dt-columns="dtColumns" class="table table-striped" id="dtTable">
									</table>
								</div>
							</div> </div>
					</div>
	...
	<script src="<?php echo e(asset('angular/Frontend/Orders/Controllers/orders-lists.js')); ?>"></script>
