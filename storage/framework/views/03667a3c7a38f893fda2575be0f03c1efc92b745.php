  	...
  	<div class="row">
		<div class="col-md-12">
			<nav class="breadcrumb ">
				...
				<span class="breadcrumb-item active">#<?php echo e($order_id); ?> Shipping Info</span>
			</nav>
		</div>
	</div>
</section>
<div class="view-order">
										...
										<div class="row">
											...
											<div class="rencemt_order_table">
												...
												<div class="box-header with-border">
													<h2 class="box-title">#<?php echo e($order_id); ?> Shipping Info</h2>
												</div>
												<div class="box-body">
	...
	<script src="<?php echo e(asset('angular/Frontend/Orders/Controllers/order-shippings.js')); ?>"></script>
