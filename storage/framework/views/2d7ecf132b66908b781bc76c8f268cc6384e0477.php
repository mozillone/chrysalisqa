...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><?php echo e($cat_data[0]->name); ?></li>
    </ol>
</section>
                ...
                <div class="box-body">
                  ...
                  <?php endif; ?>
                     <form id="category-edit" class="form-horizontal defult-form" name="userForm" action="<?php echo e(route('categories-edit')); ?>" method="POST" novalidate autocomplete="off" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="category_id" id="category_id" value="<?php echo e($cat_data[0]->category_id); ?>"> 
                        <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group has-feedback" >
                                        ...
                                        <input type="hidden" name="old_category" value="<?php echo e($cat_data[0]->name); ?>"> 
                                    </div>
                                    <div class="form-group has-feedback" >
                                     ...
                                     <div class="form-group has-feedback" >
                                        <label for="inputEmail3" class="control-label">Category Description<span class="req-field" >*</span></label>
                                            <textarea class="form-control" placeholder="Enter category description"  name="desc" id="cos_desc"><?php echo e($cat_data[0]->description); ?></textarea> 
                      ...
                      <div class="col-md-6">
                                    <div class="form-group has-feedback" >
                                        <label for="inputEmail3" class="control-label">Sort Order <span class="req-field" >*</span></label>
                                            <input type="text" class="form-control" placeholder="Sort Order"  name="sort" id="name" value="<?php echo e($cat_data[0]->sort_order); ?>">                                       
                                    </div>                                    
                      </div> 
                    </div> 
                    </div> 
                                ...
                                <table class="table table-inverse">
                                  ...
                                  <tbody id='reorder' class="assigned-products">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="/delete/categorycostume/<?php echo e($cst->costume_id); ?>/<?php echo e($cat_data[0]->category_id); ?>" class="remove_cost"  data-cost-id='<?php echo e($cst->costume_id); ?>'><i class="fa fa-trash-o" aria-hidden="true"></i></a></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
                                  </tbody>
                                </table>
