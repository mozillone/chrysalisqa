    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form" method="POST" id="charity-create" action="<?php echo e(route('charity-create')); ?>" enctype='multipart/form-data'>
                  ...
                  <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12 fileupload fileupload-new" data-provides="fileupload"> 
                            <img src="<?php echo e(asset('/charities_images/default-placeholder.jpg')); ?>" class="img-pview img-responsive" id="img-chan" name="img-chan">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form" method="POST" id="charity-edit" action="<?php echo e(route('charity-edit')); ?>" enctype='multipart/form-data'>
                  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                  ...
                  <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12 fileupload fileupload-new" data-provides="fileupload"> 
                            <img src="<?php echo e(asset('/charities_images/default-placeholder.jpg')); ?>" class="img-pview img-responsive"  id="img-chan1">
