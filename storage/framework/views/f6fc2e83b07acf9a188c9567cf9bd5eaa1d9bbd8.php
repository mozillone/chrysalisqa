			...
			<div class="row">
				<div class= "col-md-12 col-sm-12 col-xs-12">
					<div class="progressbar_main request-bag">
						<h2>REQUEST A BAG <img  src="<?php echo e(URL::asset('assets/frontend/img/bag-min.png')); ?>"></h2>
					</div>
				</div> 
				<div class="col-md-12 col-sm-12 col-xs-12 request-icon-sec">
					...
					<div class="row">
						<div class="col-md-4 col-sm-4 request-bag-steps">
							<img class="step1-img" src="<?php echo e(URL::asset('assets/frontend/img/step-1-bag.png')); ?>">
						...
						<div class="col-md-4 col-sm-4 request-bag-steps">
							<img class="step2-img" src="<?php echo e(URL::asset('assets/frontend/img/Step-2-bag.png')); ?>">
						...
						<div class="col-md-4 col-sm-4 request-bag-steps">
							<img class="step3-img" src="<?php echo e(URL::asset('assets/frontend/img/Step-3-piggy.png')); ?>">
			...
			<div class="row option-sec">
				<div class="col-md-10 col-md-offset-1">
					...
					<div id="choose_an_option_for_bag_div">
						<p class="cst2-rms-chck"><input type="checkbox" name="is_payout_no" id="is_payout_no" value="1">Don't send me a payout. I want to support Chrysalis' waste reduction and charitable donation program.</p>
						...
						<p class="cst2-rms-chck"><input type="checkbox" checked name="is_payout" value="1" id="is_payout">I agree that $9.99 will be deducted from my bag payout for the shipping and handling fee.</p>
						...
						<div class="text-center">
							...
							<p><a href="<?php echo e(URL::to('costume/create')); ?>"> Sell it Yourself! </a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container" id="average_payouts_div">
			<div class="row average-payout-sec">
					...
					<div class="row costumes">
						<div class="costumes-desktop">
							<div class="col-md-4 col-sm-4">
								<div class="cart-img">
									<img  src="<?php echo e(URL::asset('assets/frontend/img/item-1.png')); ?>">
							...
							<div class="col-md-4 col-sm-4">
								<div class="cart-img">
									<img  src="<?php echo e(URL::asset('assets/frontend/img/Item-2.png')); ?>">
									<span class="price-tag">
							...
							<div class="col-md-4 col-sm-4">
								<div class="cart-img">
									<img  src="<?php echo e(URL::asset('assets/frontend/img/Item-3.png')); ?>">
									<span class="price-tag">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="carousel-cart-img">
									<img  src="<?php echo e(URL::asset('assets/frontend/img/item-1.1.png')); ?>">
									<span class="price-tag">
							...
							<div class="item">
								<div class="carousel-cart-img">
									<img  src="<?php echo e(URL::asset('assets/frontend/img/Item-2.1.png')); ?>">
									<span class="price-tag">
										Avg Payout <span class="price-doller"> <i class="fa fa-usd" aria-hidden="true"></i>4</span>
									</span>
								</div>
							...
							<div class="item">
								<div class="carousel-cart-img">
									<img  src="<?php echo e(URL::asset('assets/frontend/img/Item-3.1.png')); ?>">
									<span class="price-tag">
										Avg Payout <span class="price-doller"> <i class="fa fa-usd" aria-hidden="true"></i>5</span>
									</span>
								</div>
				...
				<div class="col-md-8 col-md-offset-2">
					...
					<div id="myCarousel1" class="carousel costumes-carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item">
								<div class="carousel-cart-img">
									<img  src="<?php echo e(URL::asset('assets/frontend/img/Item2.2.png')); ?>">
									<span class="price-tag">
				...
				<div class="col-md-8 col-md-offset-2">
					<div class="costumes-desktop">
						<div class="costumes-label">
							<span class="film-sec"><img  src="<?php echo e(URL::asset('assets/frontend/img/film.png')); ?>">FILM QUALITY</span>
						...
						<div class="row costumes">
							...
							<div class="col-md-4 col-sm-4">
								<div class="cart-img">
									<img  src="<?php echo e(URL::asset('assets/frontend/img/Item-1.3.png')); ?>">
									<span class="price-tag">
										Avg Payout <span class="price-doller"> <i class="fa fa-usd" aria-hidden="true"></i>15</span>
									</span>
								</div>
							...
							<div class="col-md-4 col-sm-4">
								<div class="cart-img">
									<img  src="<?php echo e(URL::asset('assets/frontend/img/item-3.3.png')); ?>">
									<span class="price-tag">
										Avg Payout <span class="price-doller"> <i class="fa fa-usd" aria-hidden="true"></i>15</span>
									</span>
								</div>
						...
						<div class="tip-sec">
							...
							<a href="<?php echo e(URL::to('costume/create')); ?>">Upload it Yourself!</a>
							<img  src="<?php echo e(URL::asset('assets/frontend/img/Tip-arrow_right.png')); ?>">
						</div>
					</div>
				</div>
			</div>
					...
					<div class="request-address-sec col-md-12 col-sm-12 col-xs-12">
						<div class="col-md-6">
                            ...
                            <div class="form-rms form-align costume-error">
								...
								<p class="form-rms-input">
									...
									<select name="state" id="state">
										...
										<?php $__currentLoopData = $all_details['state_table']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
										<option <?php if (!empty($db_state) == $state->abbrev): ?>
										selected="selected"
										<?php endif ?> value="<?php echo e($state->abbrev); ?>"><?php echo e($state->name); ?></option>
							...
							<div class="condition-option clearfix">
								<p><input class="condition-check" type="checkbox" name="quality_standards" value="">All items meet our <a href="#">Quality Standards</a>
									<span id="quality_standards_error" style="color:red; display: block;"></span>
								</p>
								<p><input type="checkbox" name="reject_terms" checked value="">I have read and agree with Chrysalis' <a href="<?php echo e(route('terms-of-use')); ?>" target="_blank">Terms of Use</a>
						...
						<div class="col-md-6">
							...
							<div class="unaccepted-option">
								...
								<p class="cst2-rms-chck"><input type="radio" name="is_return" value="0">Please responsibly recycle my unaccepted items</p>
	...
	$(document).ready(function()
	{
		...
		$('#send_my_bag_next').click(function(a){
			...
			*/
			...
			if (str == true) {
				...
				$('#send_my_bag_next').append('<img id="ajax_loader" src="<?php echo e(asset("img/ajax-loader.gif")); ?>" >');
				$.ajax({
					url: "<?php echo e(URL::to('costume/postrequestabag')); ?>",
					type: "POST",
					...
					success: function(data){
						if (data == "login") {
							...
							window.location.href = "<?php echo e(URL::to('login#signup_tab')); ?>";
							loading = false;
						}
						else if (data.trim() == "success") {
							window.location.href = "<?php echo e(URL::to('costume/successrequestbag')); ?>";
							loading = false;
						}
					}
				}); 
		...
		$('#request_a_bag_login').click(function(){
			...
			if (loginpopup_email != "" && loginopup_password !="") {
				$.ajax({
					url: "<?php echo e(URL::to('/postrequestabaglogin')); ?>",
					type: "POST",
					data: total_data,
					success: function(data){
