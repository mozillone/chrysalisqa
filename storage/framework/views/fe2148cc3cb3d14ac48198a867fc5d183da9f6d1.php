          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="fileupload fileupload-new" data-provides="fileupload"> 
                <img class="img-circle"  <?php if(empty(Auth::user()->user_img)): ?> src="<?php echo e(asset('/img/default.png')); ?>" <?php else: ?> src="/profile_img/<?php echo e(Auth::user()->user_img); ?>" <?php endif; ?> class="img-pview img-responsive" id="img-chan" name="img-chan">
			...
			<div class="col-md-8 col-sm-10 col-xs-12">
              ...
              <p class="error"><?php echo e($errors->first('avatar')); ?></p> 
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" value="<?php echo e(Auth::user()->first_name); ?>" name="first_name" id="first_name">
									</div>
									<div class="form-group">
										<label for="text">Full Name</label>
										<input type="text" class="form-control" value="<?php echo e(Auth::user()->first_name); ?><?php echo e(Auth::user()->last_name); ?>" name="last_name" id="last_name">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" value="<?php echo e(Auth::user()->email); ?>" name="email" id="email">
									</div>
						...
						<div class="panel panel-default">
							...
							<div class="panel-body pay_details">
								...
								<div class="checkbox">
									...
									<label><input type="checkbox"><?php echo e($cc_list->card_type); ?> ending in <?php echo e($cc_list->credit_card_mask); ?> (default)</label>
									<p class="pymnt_right_box"><span></span> <span><a href="javascript:void(0);" onclick="deleteccard(<?php echo e($cc_list->id); ?>)"><i class="fa fa-trash-o" aria-hidden="true"></i></a></span></p>
								</div>
						...
						<div class="panel panel-default">
							...
							<?php if(isset($default_billing_address) && !empty($default_billing_address)){
								...
								<p class="bill_adrs">
									...
									<span> <?php echo e($billing_address->fname); ?><?php echo e($billing_address->lname); ?><br>
										<?php echo e($billing_address->address1); ?>

										<?php echo e($billing_address->city); ?><?php echo e($billing_address->state); ?><br>
										<?php echo e($billing_address->country); ?><?php echo e($billing_address->zip_code); ?></span>
								</p> 
								<p class="bill_adrs_dlte">
									<span><a href="#" onclick="edit_billing(<?php echo e($billing_address->address_id); ?>)"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></span> <span><a href="#" onclick="delete_address(<?php echo e($billing_address->address_id); ?>)"><i class="fa fa-trash-o" aria-hidden="true"></i></a></span>
								</p>
								<?php }else{
									$billing_address = "";
								} ?>
						...
						<div class="panel panel-default">
							...
							<?php if(isset($default_shipping_address) && !empty($default_shipping_address)){
								...
								<p class="bill_adrs">
									...
									<span> <?php echo e($shipping_address->fname); ?><?php echo e($shipping_address->lname); ?><br>
										<?php echo e($shipping_address->address1); ?>

										<?php echo e($shipping_address->city); ?><?php echo e($shipping_address->state); ?><br>
										<?php echo e($shipping_address->country); ?><?php echo e($shipping_address->zip_code); ?></span>
								</p> 
								<p class="bill_adrs_dlte">
									<span><a href="#" onclick="edit_shipping(<?php echo e($shipping_address->address_id); ?>)"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></span> <span><a href="#" onclick="delete_address(<?php echo e($shipping_address->address_id); ?>)"><i class="fa fa-trash-o" aria-hidden="true"></i></a></span>
								</p>
								<?php }else{
								$shipping_address = "";
								} ?>
							...
							<table class="table table-striped">
								...
								<tbody> 
									<?php if(count($recent_orders)): ?>
										...
										<tr> <td><?php echo e($orders->date); ?></td> <td><?php echo e($orders->order_id); ?></td> <td><?php echo e($orders->seller_name); ?></td> <td><?php echo e($orders->status); ?></td> </tr>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
									<?php else: ?>
							...
							<table class="table table-striped">
								...
								<tbody>
									<?php if(count($costumes_sold)): ?> 
										...
										<tr> <td><?php echo e($sold_costumes->date); ?></td> <td><?php echo e($sold_costumes->order_id); ?></td> <td><?php echo e($sold_costumes->buyer_name); ?></td> <td><?php echo e($sold_costumes->status); ?></td> </tr>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?> 
									<?php else: ?>
       ...
       <input type="hidden" name="is_edit" value="yes">
						...
						<div class="col-md-12 col-sm-12 col-xs-12">
							...
							<div class="address-form">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input type="text" class="form-control" id="shipping_address_1" placeholder="Address1 *" name="address_1" value="<?php if(!empty($shipping_address->address1)): ?><?php echo e($shipping_address->address1); ?> <?php endif; ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text" class="form-control" id="shipping_address_2" placeholder="Address2" name="address_2" value="<?php if(!empty($shipping_address->address2)): ?><?php echo e($shipping_address->address2); ?><?php endif; ?>">
								</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text" class="form-control" id="shipping_city" placeholder="City *" name="city" value="<?php if(!empty($shipping_address->city)): ?><?php echo e($shipping_address->city); ?><?php endif; ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text" class="form-control" id="shipping_postcode" placeholder="Zipcode *" name="postcode" value="<?php if(!empty($shipping_address->zip_code)): ?><?php echo e($shipping_address->zip_code); ?><?php endif; ?>">
									</div>
								</div>
								<div class="col-md-6">
										<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										<select class="form-control" name="country" id="shipping_country">
												<option value="" selected> Select</option>
												<?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cnt): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
												<option value="<?php echo e($cnt->country_name); ?>" <?php if (!empty($shipping_address->country) == $cnt->country_name) { ?> selected="selected" <?php } ?>><?php echo e($cnt->country_name); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
										</select>
									</div>
								</div>
				...
				<div class="chek-out">
							<div class="new_address">
								<div class="address-form">
									...
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" id="billing_address_1" placeholder="Address1 *" name="address_1" value="<?php if(isset($billing_address->address1)): ?><?php echo e($billing_address->address1); ?><?php endif; ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" id="billing_address_2" placeholder="Address2" name="address_2" value="<?php if(isset($billing_address->address2)): ?><?php echo e($billing_address->address2); ?><?php endif; ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" id="billing_city" placeholder="City *" name="city" value="<?php if(isset($billing_address->city)): ?><?php echo e($billing_address->city); ?><?php endif; ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<input type="text" class="form-control" id="billing_postcode" placeholder="Zipcode *" name="postcode" value="<?php if(isset($billing_address->zip_code)): ?><?php echo e($billing_address->zip_code); ?><?php endif; ?>">
										</div>
									</div>
									<div class="col-md-6 col-sm-6 col-xs-12">
										<div class="form-group">
									...
									<div class="col-md-6">
										<div class="form-group">
											<select class="form-control" name="country" id="billing_country">
													<option value="" selected> Select</option>
													<?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cnt): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
													<option value="<?php echo e($cnt->country_name); ?>" <?php if (!empty($billing_address->country) == $cnt->country_name) { ?> selected="selected" <?php } ?>><?php echo e($cnt->country_name); ?></option>
													<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
											</select>
										</div>
									</div>
...
function  delete_address($id){
	...
	if (confirm("Are you sure?")) {
		$.ajax({
		 ...
		 success: function(data){
		 	if (data == "success") {
		 		window.location.href = "<?php echo e(URL::to('/dashboard')); ?>";
		 	}
		 }});
	    }
	    return false;
	...
	if (confirm("Are you sure?")) {
		$.ajax({
		 url: "<?php echo e(URL::to('/deleteccard')); ?>",
		 type: "POST",
		 data: {'id':id},
		 success: function(data){
		 	if (data == "success") {
