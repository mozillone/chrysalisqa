			...
			<div class="thankyou-rm">
				...
				<div class="col-md-6 col-sm-6 col-md-6">
                    ...
                    <!-- image logic -->
                        ...
                        <!-- end image logic -->
					<li>
                        <img src="<?php echo e(URL::asset($listingImage)); ?>" alt="cst3" /><p class="crt-name"><?php echo e($charities->name); ?></p><input type="radio" name="charity" id="charity1" value="<?php echo e($charities->id); ?>"/>
                    </li>
