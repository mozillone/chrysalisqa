					...
					<div class="row">
						<div class="col-md-12">
							<div class="icon_lins text-right">
								<ul> 
									<li><a href="<?php echo e(URL::to('conversations')); ?>" type="button" class="btn btn-default btn-lg text-center"><i class="fa fa-envelope-open" aria-hidden="true"></i><br>Messages</a></li>
									...
									<li><button type="button" class="dropdown-toggle btn btn-default btn-lg text-center mini-cart" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-shopping-cart" aria-hidden="true"></i><br>Cart <span class="mini_cart"><?php echo e(helper::getCartCount()); ?></span></button>
							...
							<div class="navbar-header">
								...
								<a class="navbar-brand" href="/"><img class="img-responsive" src="<?php echo e(asset('/img/brand.png')); ?>"></a>
							</div>
					...
					<nav class="navbar navbar-default">
						...
						<div class="collapse navbar-collapse js-navbar-collapse">
							...
							<?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
								...
								<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo e($key); ?> <?php if(count($value)>1): ?><i class="fa fa-chevron-down" aria-hidden="true"></i><?php endif; ?></a>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-7">
						...
						<button type="button" class="navbar-toggle respnsive-ser-rm" data-toggle="collapse" data-target=".nav-search" data-collapse-group="myDivs">
							<a data-toggle="modal" <?php if(!Auth::check()): ?> data-target="#login_popup" <?php endif; ?>><i class="fa fa-user" aria-hidden="true"></i></a>
						</button>
						<button type="button" class="navbar-toggle respnsive-ser-rm" data-toggle="collapse" data-target=".nav-search" data-collapse-group="myDivs">
									...
									<ul class="responsive-rm">
										<li>CATEGORIES <span class="mobile-plus"><i class="fa fa-plus" aria-hidden="true"></i></span>
											...
											<ul class="responsive-inner none-rm">
												<?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
													<li><?php echo e($key); ?><i class="fa fa-chevron-down" aria-hidden="true"></i></li>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getFirstLoop(); ?>
											</ul>			
											<!--inner menu end-->			
										</li>
