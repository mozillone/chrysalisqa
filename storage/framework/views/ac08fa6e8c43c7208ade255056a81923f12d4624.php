...
<?php $__env->startSection('content'); ?>
    <div class="container blog-sec">
        ...
        <nav class="breadcrumb">
            ...
            <span class="breadcrumb-item active"><?php echo e($tag); ?></span>
        </nav>
        ...
        <div class="row">
            <div class="col-md-9 col-sm-9 col-xs-12">
                <div class="row">
                    ...
                    <?php $__currentLoopData = $postsByTag; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blogPost): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                        <?php
                        ...
                        <div class="col-md-6">
                            <div class="blog-card">
                                ...
                                <p class="blog-description"><?php echo $blogPost->description; ?></p>
                                <hr/>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div style="float:right;"><?php echo e($postsByTag->links()); ?></div>
                </div>
            </div>
            <!-- end listing -->
            <div class="col-md-3">
...
<?php $__env->startSection('footer_scripts'); ?>
    ...
    <script src="<?php echo e(asset('/assets/frontend/js/pages/blog_tag.js')); ?>"></script>
