	...
	<option <?php if ($cos_data->customer_name == 'admin m') { ?> selected="selected"<?php } ?> value="1">None</option>
	...
	<input type="{{$cosplay_one->type}}"   name="{{$cosplay_one->code}}" id="{{$cosplay_one->code}}"  value="{{$cosplayonevalues->option_id}}" required>&nbsp;
	...
	<label><input type="radio" name="cosplayplay_yes_opt" @if($cosplayplay_yes_opt->attribute_option_value == "Anime/Manga") checked="checked" @endif value="Anime/Manga">Anime/Manga</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="cosplayplay_yes_opt" @if($cosplayplay_yes_opt->attribute_option_value == "Sci-Fi") checked="checked" @endif  value="Sci-Fi">Sci-Fi</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="cosplayplay_yes_opt" @if($cosplayplay_yes_opt->attribute_option_value == "Cosmic/Superhero") checked="checked" @endif  value="Cosmic/Superhero">Cosmic/Superhero</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="cosplayplay_yes_opt" @if($cosplayplay_yes_opt->attribute_option_value == "Video Games") checked="checked" @endif value="Video Games">Video Games</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="cosplayplay_yes_opt" @if($cosplayplay_yes_opt->attribute_option_value == "Furries") checked="checked" @endif value="Furries">Furries</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="cosplayplay_yes_opt" @if($cosplayplay_yes_opt->attribute_option_value == "Other") checked="checked" @endif value="Other">Other</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="cosplayplay_yes_opt" @if($cosplayplay_yes_opt->attribute_option_value == "Film & Tv") checked="checked" @endif value="Film & Tv">Film & Tv</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="cosplayplay_yes_opt" @if($cosplayplay_yes_opt->attribute_option_value == "Mecha") checked="checked" @endif value="Mecha">Mecha</label>
	</div>
	</div>
	...
	<input type="{{$cosplay_two->type}}"   name="{{$cosplay_two->code}}" id="{{$cosplay_two->code}}"  value="{{$cosplaytwovalues->option_id}}" onclick="uniquefashion_yes({{$cosplaytwovalues->option_id}})"  required>&nbsp;
	...
	<div class="col-md-12" >
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Cyberpunk") checked="checked" @endif value="Cyberpunk">Cyberpunk</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Lolita") checked="checked" @endif value="Lolita">Lolita</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Dystopain") checked="checked" @endif value="Dystopain">Dystopain</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Mori kei") checked="checked" @endif value="Mori kei">Mori kei</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Goth") checked="checked" @endif value="Goth">Goth</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Fari kei") checked="checked" @endif value="Fari kei">Fari kei</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Steampunk") checked="checked" @endif value="Steampunk">Steampunk</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Visual kei") checked="checked" @endif value="Visual kei">Visual kei</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Streetwear") checked="checked" @endif value="Streetwear">Streetwear</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="uniquefashion_yes_opt" @if($uniquefashion_yes_opt->attribute_option_value == "Other") checked="checked" @endif value="Other">Other</label>
	</div>
	</div>
	...
	<input type="{{$cosplay_three->type}}" name="{{$cosplay_three->code}}" id="{{$cosplay_three->code}}" onclick="activity_yes({{$cosplaythreevalues->option_id}})"  value="{{$cosplaythreevalues->option_id}}"  required>&nbsp;
	...
	<div class="col-md-12" >
	<div class="radio-inline">
	<label><input type="radio" name="activity_yes_opt" @if($activity_yes_opt->attribute_option_value == "Circus") checked="checked" @endif value="Circus">Circus</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="activity_yes_opt" @if($activity_yes_opt->attribute_option_value == "Theatre") checked="checked" @endif value="Theatre">Theatre</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="activity_yes_opt" @if($activity_yes_opt->attribute_option_value == "Historical Reenactments") checked="checked" @endif value="Historical Reenactments">Historical Reenactments</label>
	</div>
	<div class="radio-inline">
	<label><input type="radio" name="activity_yes_opt"  @if($activity_yes_opt->attribute_option_value == "Music Videos") checked="checked" @endif value="Music Videos">Music Videos</label> 
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="activity_yes_opt" @if($activity_yes_opt->attribute_option_value == "LARP") checked="checked" @endif value="LARP">LARP</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="activity_yes_opt" @if($activity_yes_opt->attribute_option_value == "Masquerade") checked="checked" @endif value="Masquerade">Masquerade</label>
	</div>
	</div>
	<div class="col-md-12">
	<div class="radio-inline">
	<label><input type="radio" name="activity_yes_opt" @if($activity_yes_opt->attribute_option_value == "Medieval/Renaissance Fairs") checked="checked" @endif value="Medieval/Renaissance Fairs">Medieval/Renaissance Fairs</label>
	</div>
	</div>
	...
	<input type="{{$cosplay_four->type}}"  name="{{$cosplay_four->code}}" id="{{$cosplay_four->code}}"  value="{{$cosplayfourvalues->option_id}}" onclick="make_costume_yes({{$cosplayfourvalues->option_id}})"  required>&nbsp;
	...
	<input type="{{$cosplay_five->type}}"  name="{{$cosplay_five->code}}" id="{{$cosplay_five->code}}"  value="{{$cosplayfivevalues->option_id}}"  required >&nbsp;
...
<p class="error">{{ $errors->first('name') }}</p>
	...
	<select class="form-control" name="charity_amount" id="charity_amount"><option value="">Donate Amount</option>
		...
		<option <?php if($cos_data->donation_percent == '30'){ ?> selected="selected" <?php } ?> value="30">30%</option></select>
...
<input type="hidden" name="hidden_donation_amount" id="hidden_donation_amount" value="{{$cos_data->donation_amount}}">
	...
	<div class="col-md-3 col-sm-3 col-xs-12" id="front_view">
		<h2 class="box-title col-md-12 heading-agent pro-imgs text-center" >Front View</h2>
			...
			<div class=" up-blog">
			<input type="file" name="img_chan"  id="img_chan" value="1">
