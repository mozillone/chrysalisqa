...
<link rel="stylesheet" href="http://chrysalis.com/vendors/jquery-ui/themes/base/sortable.css">
@endsection
		...
		<div class="container create-list-tldiv">
			...
			@endif
				...
				<div class="col-md-12">
					...
					<li data-image-id="{{$data['list_images'][0]->id}}"><div class="col-md-2 col-sm-2 col-xs-4 blk">
						<a href="" class="image-remove">
							  <input type="hidden" name="images_ids[]" value="{{$data['list_images'][0]->id}}"/>
						  <img class="img-responsive" src="/uploads/listing_images/popups/{{$data['list_images'][0]->filename}}" />
...
<script src ="http://chrysalis.com/vendors/jquery-ui/jquery-ui.min.js"></script>
     ...
     stop: function(event, ui) {
		 ...
		 $.ajax({
           	        url: "/list/image/position/update",
            	        method:"POST",
            	        data:{new_position:new_position,old_position:old_position,image_id:image_id,_token:_token},
            	 		async: true,
