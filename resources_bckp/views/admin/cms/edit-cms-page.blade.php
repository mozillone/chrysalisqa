            ...
            <div class="col-sm-12 col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title col-md-12 heading-agent">Edit Page</h3>
                    </div>
                    ...
                    <div class="box-body">
                        ...
                        @endif
                            ...
                            <form id="edit_cms_page" class="form-horizontal defult-form" name="editCmsPage" action="/update-page/{{$page->id}}" method="POST" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group has-feedback" >
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Page Title" value="{{ $page->title }}" name="title" id="page_title">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group has-feedback" >
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Meta Title" value="{{ $page->meta_title }}" name="meta_title" id="meta_title">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <textarea id="meta_desc" class="form-control" rows="6" name="meta_desc">{{ $page->meta_desc }}</textarea>
