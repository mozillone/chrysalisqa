						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="img-pp">
									<div class="img-pp-iner">
										<img class="img-responsive crp1" src="{{URL::asset('assets/frontend/img/crp_1.png')}}">
										<input type="range"  min="0" value="2" step="any" max="4" class="slider">
										<img class="img-responsive crp2" src="{{URL::asset('assets/frontend/img/crp_1.png')}}">
									</div>
								</div>
										...
										<div class="col-md-8 col-sm-8">
											<div class="col-md-12 col-sm-12 col-xs-12 pdlft0" >
												...
												<div class="col-md-3 col-sm-4 pdlft5">
													<input id="radio-7" class="radio-custom conditon_check" name="condition" type="radio" value="likenew">
...
$(document).ready(function()
{
	...
	/*$("input[type='text']").data('holder',$("input[type='text']").attr('placeholder'));
	    ...
	    if (!isNaN(currentVal)) {
	        if(type == 'minus') {            
	            if(currentVal <= 10){
               		...
               		if(currentVal > input.attr('min')) {
                   		input.val((currentVal - 10)+" %").css({"color":"","font-weight":""}).change();
                   	}
                   	if(parseInt(input.val()) == input.attr('min')) {
                   		$(this).attr('disabled', true);
                   	}
               		...
               		if(currentVal > input.attr('min')) {
                   		input.val((currentVal - 25)+" %").change();
                   	}
                   	if(parseInt(input.val()) == input.attr('min')) {
                   		$(this).attr('disabled', true);
                   	}
	            ...
	            if(currentVal < 10){
           			...
           			if(currentVal < input.attr('max')) {
                   		input.val((currentVal + 5)+" %").css({"color":"","font-weight":""}).change();
                   	}
                   	if(parseInt(input.val()) == input.attr('max')) {
                   		$(this).attr('disabled', true);
                   	}
