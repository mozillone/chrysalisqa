...
<option <?php if($status == "Draft") {?> selected="selected" <?php } ?> value="Draft">Draft</option>
<option <?php if($status == "Publish") {?> selected="selected" <?php } ?> value="Publish">Publish</option>
