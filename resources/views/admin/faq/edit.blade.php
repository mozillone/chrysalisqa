            ...
            <div class="col-sm-12 col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form id="edit_faq" class="form-horizontal defult-form" name="editFaq" action="/update-faq/{{ $faq->id }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group has-feedback" >
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter FAQ Title" value="{{ $faq->title }}" name="title" id="faq_title">
                                    ...
                                    <div class="form-group has-feedback">
                                        ...
                                        <textarea id="faq_description" class="form-control" name="faq_description">{{ $faq->description }}</textarea>
                                    ...
                                    <div class="form-group has-feedback" >
                                        ...
                                        <input type="text" name="sort_no" class="form-control" value="{{ $faq->sort_no }}" id="sorting"/>
