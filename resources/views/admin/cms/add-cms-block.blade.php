            ...
            <div class="col-sm-12 col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <form id="add_cms_block" class="form-horizontal defult-form" name="addCmsBlock" action="{{route('store-cms-block')}}" method="POST" autocomplete="off" enctype="multipart/form-data">
