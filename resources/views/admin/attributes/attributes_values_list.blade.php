         ...
         @endif
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <a href="{{route('attribute-value-create')}}" class="btn btn-block btn-success btn-xs"><i class="fa fa-plus"></i> Add Attributes Value</a>
                    </div>
                </div>
                <div class="box-body">
...
<script src="{{ asset('/angular/Admin/Attributes/Controllers/attributes-values-lists.js') }}"></script>
