...
<table style="font-weight:normal;border-collapse:collapse;border:0;margin:0;padding:0;font-family:Arial,sans-serif;width:100%">
	<tbody>
		<tr>
			...
			<h1 style="margin:10px 35px;color:#333;font-size:25px;font-weight:normal"><span class="sg-image"><img height="28" src="{{asset('assets/frontend/img/brand.png')}}" style="width: 206px; height: 28px;" width="206" /></span></h1>
