...
<tbody>
    <tr>
        <td><p>© 2017 CHRYSALIS. ALL RIGHTS RESERVED​​​​​​​ | <a href="{{URL::to('/pages/terms-of-use/')}}" style="color: #222;">TERMS OF USE</a> | <a href="{{URL::to('/pages/privacy-policy/')}}" style="color: #222;"> PRIVACY POLICY </a></p></td>
    </tr>   
</tbody>
</table>
