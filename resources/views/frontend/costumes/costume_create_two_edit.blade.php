										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="img-pp">
													<div class="img-pp-iner">
														<img class="img-responsive crp1" src="{{URL::asset('assets/frontend/img/crp_1.png')}}">
														<input type="range" id="zoom-level2" min="0" value="2" step="any" max="4">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="img-pp">
													<div class="img-pp-iner">
														<img class="img-responsive crp1" src="{{URL::asset('assets/frontend/img/crp_1.png')}}">
														<input type="range" id="zoom-level3" min="0" value="2" step="any" max="4">
														<img class="img-responsive crp2" src="{{URL::asset('assets/frontend/img/crp_1.png')}}">
													</div>
												</div>
												<div class="width"></div>
						...
						<div class="prog-form-rm">
							<div class="col-md-12 col-xs-12 col-sm-12 ">
										...
										<div class="form-rms-input">
											...
											<p class="form-rms-dim form-rms-he"><?php echo ucfirst($heading); ?> <br/> 
												...
												<input type="{{$bodyanddimensions->code}}" name="{{$body_height_ft->value}}" id="{{$body_height_ft->value}}" value="{{$db_body_height_ft->attribute_option_value}}"> <span><?php echo $heading_value;?></span>
											     @if(empty($db_body_height_in->attribute_option_value))
												 <input type="{{$bodyanddimensions->code}}" class="form-rms-dt" name="{{$body_height_in->value}}" id="{{$body_height_in->value}}" value="0"> <span><?php echo $heading_value_in; ?></span>
												 @else
											...
											<p class="form-rms-dim weight-chest"><?php echo ucfirst($heading_weight_value); ?> <br/> 
												<span class="form-rms-he1">
												    @if(empty($db_body_weight_lbs->attribute_option_value))
													<input type="text" name="{{$body_weight_lbs->value}}" id="{{$body_weight_lbs->value}}" value="0"> <span><?php echo $heading_weight_value_lbs;?></span>
													@else
											...
											<p class="form-rms-dim weight-chest"><?php echo ucfirst($heading_chest_value); ?> <br/> 
												<span class="form-rms-he1">
													@if(empty($db_body_chest_in->attribute_option_value))
													<input type="text" name="{{$body_chest_in->value}}" id="{{$body_chest_in->value}}" value="0" > <span><?php echo $heading_chest_value_in; ?> </span>
													@else
											...
											<p class="form-rms-dim weight-chest"><?php echo ucfirst($heading_waist_value); ?> <br/> 
												<span class="form-rms-he1">
												    @if(empty($db_body_waist_lbs->attribute_option_value))
													<input type="text" name="waist-inches" id="waist-inches" value="0"> <span>in</span>
													@else
								...
								<div class="form-rms hide" id="cleaned_select">
									...
									<option <?php if ($handling_costume->option_id == '136') { ?> selected='selected' <?php } ?> value="136" >Hand Washed</option>

									<option <?php if ($handling_costume->option_id == '137') { ?> selected='selected' <?php } ?> value="137">Machine Washed</option>

									<option <?php if ($handling_costume->option_id == '138') { ?> selected='selected' <?php } ?> value="138">Professionally Cleaned</option>
...
" name="description" id="description" maxlength="600" >{{$costume_description->description}}</textarea></p>
						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<div class="form-rms pricess pric_tag_three">
									...
									<p class="cst2-textl2">Not Sure? <i class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="right" title="If your costume has been worn before, we recommend selling it for 50-60% of its purchase price. If you made the costume yourself, we suggest considering the time you'd spent and cost of materials."></i></p></div>
								...
								<div class="form-rms">
									...
									<div class="col-md-8 col-sm-8 col-xs-12">
										<div class="form-rms-input dimensions-two dimensions-two-pk_info">
											<p class="form-rms-dim">  <span class="form-rms-he1"><input id="Length" name="Length" value="@if(!empty($db_dimensions_length->attribute_option_value)) {{$db_dimensions_length->attribute_option_value}} @endif" type="text"> <span>in x</span></span><span> Length</span> <br></p>
											<p class="form-rms-dim"> <span class="form-rms-he1"><input id="Width" name="Width" value="@if(!empty($db_dimensions_width->attribute_option_value)){{$db_dimensions_width->attribute_option_value}} @endif" type="text"> <span>in x</span></span><br> <span>Width</span> </p>
											<p class="form-rms-dim"> <span class="form-rms-he1"><input id="Height" name="Height" value="@if(!empty($db_dimensions_height->attribute_option_value)){{$db_dimensions_height->attribute_option_value}}@endif" type="text"> <span>in </span></span><span> Height</span> <br> </p>
										</div>
				...
				<script type="text/javascript">
						$(document).ready(function(){
							...
							if(parseInt($("#donate_charity").val())==10){
								$("#donate_charity").css({"color":"#5fc5ac","font-weight":""});
							}
					    ...
					    //End
                            ...
                            $('#price,#pounds,#Length,#Width,#Height').on('keydown', function(e){-1!==$.inArray(e.keyCode,[46,8,9,27,13,110,190])||/65|67|86|88/.test(e.keyCode)&&(!0===e.ctrlKey||!0===e.metaKey)||35<=e.keyCode&&40>=e.keyCode||(e.shiftKey||48>e.keyCode||57<e.keyCode)&&(96>e.keyCode||105<e.keyCode)&&e.preventDefault()});
