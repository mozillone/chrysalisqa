				...
				<div class="col-md-10 col-md-offset-1">
					...
					<div id="choose_an_option_for_bag_div">
						<p class="cst2-rms-chck">
							<input type="checkbox"  name="is_payout_no" id="is_payout_no" value="1">Don't send me a payout. I want to support Chrysalis' waste reduction and charitable donation program.
						</p>
						...
						<p class="cst2-rms-chck">
							<input type="checkbox" checked name="is_payout" value="1" id="is_payout">I agree that $9.99 will be deducted from my bag payout for the shipping and handling fee.
							</p>
