        ...
        <div class="request-address-sec">
					...
					<div class="col-md-6">
						...
						<div class="unaccepted-option">
                            ...
                            <p class="cst2-rms-chck"><input type="checkbox" id="is_recycle" name="is_recycle"  value="1" >Please responsibly recycle my unaccepted items</p>
						</div>
