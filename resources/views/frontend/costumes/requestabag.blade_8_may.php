    ...
    <div class="row option-sec">
        ...
        <h4>Choose an option of how you would like to receive your Bag and payout.</h4>
             <div id="choose_an_option_for_bag_div">
                					...
                					<p class="cst2-rms-chck"><input type="checkbox" checked disabled name="is_payout" value="1" id="is_payout">I want to pay a $9.99 Shipping & Handling fee to receive my bag (fee deducted after bag has been processed).</p>
        ...
        <div class="request-address-sec">
					...
					<div class="col-md-6">
						...
						<div class="unaccepted-option">
                            ...
                            <p class="cst2-rms-chck"><input type="checkbox" checked disabled name="is_recycle" value="1">Please responsibly recycle my unaccepted items</p>
						</div>
...
$(document).ready(function()
{
	...
	$('#send_my_bag_next').click(function(a){
		...
		if (str == true) {
			$('#is_payout').prop('disabled','false');
			$('input[name=is_recycle]').prop('disabled','false');
