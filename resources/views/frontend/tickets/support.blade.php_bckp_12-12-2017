			...
			<div class="panel panel-default">
				<div class="panel-heading" role="tab" id="heading-{{ $faq->id }}">
					<h4 class="panel-title">
						<a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse-{{ $faq->id }}" <?php echo (($counter == 0) ? "aria-expanded='true'" : "aria-expanded='false'") ?> aria-controls="collapse-{{ $faq->id }}" class="clps">
							{{ $faq->title }}
				...
				<div id="collapse-{{ $faq->id }}" class="panel-collapse collapse  @if($counter==0)  @endif" role="tabpanel" aria-labelledby="heading-{{$faq->id}}" role="tabpanel"
