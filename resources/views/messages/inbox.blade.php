      ...
      <div  class="row">        
        <div class="col-md-2 col-sm-3">
            <ul class="nav nav-tabs tabs-left">
                <li class="active"><a href="{{ url('conversations') }}">Inbox ({{$msgs_inbox[0]->count_dt}})<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
                <li><a href="{{ url('sendbox') }}">Sent ({{$msgs_sent[0]->count_dt}})<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
