                    ...
                    @if(count($conversations_inbox)>0)
                        <div class="people-list" id="people-list">
                            ...
                            <div class="list front_chat" id="myUL">
                                ...
                                <a href="@if(!empty($inbox->costume_id)){{URL::to('message')}}<?php echo '/'.$inbox->conversation_id; ?>@else javascript:void(0); @endif">
                                ...
                                <div class="col-md-2 col-sm-2 text-center">
                                    ...
                                    <p class="order_cnt"> @if($inbox->type == "request_a_bag") Ref no @else Product Id @endif #: {{$inbox->type_id}}</p>
