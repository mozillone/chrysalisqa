...
<?php if(isset($front_image->image) && !empty($front_image->image)){
	...
	<input type="hidden" name="Imagecrop1" data-id ={{$front_image->image}} class="Forntview" value="">
...
<?php if(isset($back_image->image) && !empty($back_image->image)){
	...
	<input type="hidden" name="Imagecrop2" data-id ={{$back_image->image}} class="Backview" value="">
...
<?php if(isset($details_image->image) && !empty($details_image->image)){
	...
	<div class="drop_uploader drop_zone drop_zone3">
		...
		<ul class="files thumb">
			...
			<input type="hidden" name="Imagecrop3" data-id ={{$details_image->image}} class="Additional" value="">
...
<p class="form-rms-input">
	<select name="gender" id="gender">
		...
		<option <?php if ($costume_details->gender == "boy") { ?> selected="selected" <?php } ?> value="boy">Boys</option>
		<option <?php if ($costume_details->gender == "girl") { ?> selected="selected" <?php } ?>  value="girl">Girls</option>
		<option <?php if ($costume_details->gender == "baby") { ?> selected="selected" <?php } ?> value="baby">Babies</option>
	</select>
</p>
