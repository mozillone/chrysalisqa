				...
				<div class="row">
					<div class="col-md-8 col-sm-12 col-xs-12"><h3>SIGN UP FOR OUR NEWSLETTER</h3>
						...
						<div class="news_ltr">
							...
							<input type="text" name="subscribe_email" id="subscribe_email"   pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"  placeholder="Enter your email address">
						...
						<div class="row">
							...
							<div class="col-md-8 col-sm-12 col-xs-12 social-img">
								<div class="social-icons">
									<a href="https://www.facebook.com/Chrysalis-Costumes-1571674966183606/"><img class="img-responsive" src="{{asset('/assets/frontend/img/fb-icon.png')}}"></a>
									<a href=""><img class="img-responsive" src="{{asset('/assets/frontend/img/twit-icon.png')}}"></a>
									<a href="https://www.instagram.com/chrysaliscostumes/?hl=en/"><img class="img-responsive" src="{{asset('/assets/frontend/img/insta-icon.png')}}"></a>
			...
			<div class="container">
				...
				<div class="footer_links" id="footer-middle">
					...
					<div class="footer_head ">
						...
						<p  class="shw-msg">Revolutionize the costume industry, by giving people access to more affordable, environmentally friendly costumes. More on our mission <a style="border-bottom: 1px solid #ccc">here</a>.</p>
					...
					<div class="footer_head mid_ft">
						...
						<ul class="col-md-6 col-sm-6 col-xs-12 shw-msg">
							<li><a href="/pages/about-us">About</a></li>
							<li><a href="/pages/how-it-works">How It Works</a></li>
							<li><a href="/contact-support">Support & Contact</a></li>
							<li><a href="{{ route('events') }}">Events</a></li>
						</ul>
						<ul class="col-md-6 col-sm-6 col-xs-12 snd-ul shw-msg">
	...
	if(str==true){
		  $.ajax({
                    type: "POST",
                            ...
                            if(data.code=="200"){
                            	$('#subscribe_email').val('');
                            	$('#subscribeerror').html(data.description).css({'color': 'green', 'font-weight': '100'});

                            }
                            if(data.code=="204"){
                            	
                            	$('#subscribeerror').html(data.description).css({'color': 'red', 'font-weight': '100'});
