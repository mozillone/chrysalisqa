...
<<<<<<< HEAD:storage/framework/views/445a362e739ee623a6dc2e59c386c56779381e4a.php
...
>>>>>>> df56e24abd47ac5989ea968473c4dd05288bcc9e:resources/views/frontend/partials/footer.blade (copy).php
							<li><a href="#">Jobs</a></li>
...
=======
						<div class="row hidden-xs hidden-sm">
							<div class="col-md-6 col-xs-12 co-sm-6 col-lg-6">
...
<script>
	$(document).ready(function () {
		...
		$(pages).each(function (index,data) {
            $('.mid_ft ul li a').each(function (key,value) {
				if($(this).text() == data.title){
					$(this).attr('href', 'pages/'+data.url);
				}
            });
		});
    });
