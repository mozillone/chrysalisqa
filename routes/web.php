...
Route::any('/billing_address', ['as' => 'billing_address','uses'=>'DashboardController@addBillingAddress']);
Route::any('/delete_address', ['as' => '','uses'=>'DashboardController@deleteAddress']);
