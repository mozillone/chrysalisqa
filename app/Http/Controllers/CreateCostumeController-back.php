...
class CreateCostumeController  extends Controller {
	...
	public function Costumecreate(Request $request){
		 ...
		 */
		 $customer_group="user";
			...
			$insert_costume=DB::table('costumes')->insertGetId($costume);
			 ...
			 $file1 = Imageresize::CreateCostumeFrontend1($request->file1);
			 ...
			 $file2 = Imageresize::CreateCostumeFrontend2($request->file2);
	            ...
	            if (isset($request['file4']) && !empty($request['file4'])) {
	            	foreach ($request['file4'] as $file4) {
			 			$file4 = Imageresize::CreateCostumeFrontend4($file4);
		...
		*/
			...
			*/
			...
			return response()->json(['msg' => 'success', 'cat_url' => '/category/'.$list_url_arr[1].'/'.$list_url_arr[2] ]);
	...
	public function EditCostumeAdd(Request $request){
		...
		//$delete_costume_images = DB::table('costume_image')->where('costume_id',$request->costume_id)->delete();
		$delete_costume_attributes = DB::table('costume_to_category')->where('costume_id',$request->costume_id)->delete();
			...
			if($request->file1 != ""){
				...
				$file1 = Imageresize::CreateCostumeFrontend1($request->file1);
				$file_db_array1 = array('costume_id'=>$request->costume_id,
	            	'image'=>$file1,
	            	'type'=>1,
	            	'sort_order'=>0,
	            	);
			...
			if($request->file2 != ""){
				...
				$file2 = Imageresize::CreateCostumeFrontend2($request->file2);
				$file_db_array2 = array('costume_id'=>$request->costume_id,
	            	'image'=>$file2,
	            	'type'=>1,
	            	'sort_order'=>0,
	            	);
			...
			if($request->file3 != ""){
				...
				$file3 = Imageresize::CreateCostumeFrontend3($request->file3);
				$file_db_array3 = array('costume_id'=>$request->costume_id,
	            	'image'=>$file3,
	            	'type'=>1,
	            	'sort_order'=>0,
	            	);
	            ...
	            if (isset($request['file4']) && !empty($request['file4'])) {
	            	foreach ($request['file4'] as $file4) {
	            		$file4 = Imageresize::CreateCostumeFrontend4($file4);
	            		$file_db_array4 = array('costume_id'=>$request->costume_id,
	            			'image'=>$file4,
	            			'type'=>4,
	            			'sort_order'=>0,
	            		);
		...
		*/
		...
		|@attribute_option_value
		*/
		if ($makecostume == 30 && isset($request->make_costume_time) && !empty($request->make_costume_time)) {
			...
			$make_costume_timeinsert=DB::table('costume_attribute_options')->insert($make_costume_time);
		}else if($makecostume == 31){
            $makeCostumeExists = DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>29])->count();
            if($makeCostumeExists == 1){
                DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>29])->delete();
            }
        }
		/*
		|Table:costume_attribute_options
		...
		|@attribute_option_value
		*/
		if ($filmquality == 32 && isset($request->film_name) && !empty($request->film_name)) {
			...
			$make_costume_timeinsert=DB::table('costume_attribute_options')->insert($film_name);
		}else if($filmquality == 33){
            $filmQualityExists = DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>30])->count();
            if($filmQualityExists == 1){
                DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>30])->delete();
            }
        }
		/*
		|Table:costume_attribute_options
		...
		|@attribute_option_value
		*/
		if ($cosplay == 7 && isset($request->cosplayplay_yes_opt) && !empty($request->cosplayplay_yes_opt)) {
			$get_attr_opt_value_id = DB::table('attribute_options')->where('option_value',$request->cosplayplay_yes_opt)->first(['option_id']);
            ...
            $cosplayExists = DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>25])->count();
            if($cosplayExists == 1){
                DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>25])->delete();
            }
        }
		/*
		|Table:costume_attribute_options
		...
		|@attribute_option_value
		*/
		if ($fashion == 9 && isset($request->uniquefashion_yes_opt) && !empty($request->uniquefashion_yes_opt)) {
			$get_attr_opt_value_id = DB::table('attribute_options')->where('option_value',$request->uniquefashion_yes_opt)->first(['option_id']);
            ...
            $fashionExists = DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>26])->count();
            if($fashionExists == 1){
                DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>26])->delete();
            }
        }
		/*
		|Table:costume_attribute_options
		...
		|@attribute_option_value
		*/
		if ($activity == 11 && isset($request->activity_yes_opt) && !empty($request->activity_yes_opt)) {
			$get_attr_opt_value_id = DB::table('attribute_options')->where('option_value',$request->activity_yes_opt)->first(['option_id']);
            ...
            $activityExists = DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>28])->count();
            if($activityExists == 1){
                DB::table('costume_attribute_options')->where(['costume_id'=>$req['costume_id'],'attribute_id'=>28])->delete();
            }
        }
		/*
		|Table:costume_attribute_options
		...
		*/
			switch($cosplay){ case '7': $cosplay_value="yes"; break; case '8': $cosplay_value="No"; break; }
			$cosplay_value=array('costume_id'=>$request->costume_id,
			'attribute_id'=>'2',
			'attribute_option_value_id'=>$cosplay,
			'attribute_option_value'=>$cosplay_value,
			);
			...
			//uniquefashion insertion
			switch($fashion){ case '9': $fashion_val="yes"; break; case '10': $fashion_val="No"; break; }
			$unique_fashion=array('costume_id'=>$request->costume_id,
			'attribute_id'=>'3',
			'attribute_option_value_id'=>$fashion,
			'attribute_option_value'=>$fashion_val,
			);
			...
			//Activity
			switch($activity){ case '11': $activity_value="yes"; break; case '12': $activity_value="No"; break; }
			$activity_val=array('costume_id'=>$request->costume_id,
			'attribute_id'=>'4',
			'attribute_option_value_id'=>$activity,
			'attribute_option_value'=>$activity_value,
			);
