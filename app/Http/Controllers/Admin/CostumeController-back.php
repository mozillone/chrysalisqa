...
class CostumeController extends Controller
{
	...
	*/
	 ...
	 */
		...
		if($insert_costume){
				$file1 = Imageresize::CreateCostumeFrontend1($request->img_chan);
				...
				$file_db_array1 = array('costume_id'=>$costume_id,
                    ...
                    if (isset($request['img_chan1']) && !empty($request['img_chan1'])) {            
	            
				$file2 = Imageresize::CreateCostumeFrontend2($request->img_chan1);
			             //inserting in db
	    		...
	    		if (isset($request['img_chan2']) && !empty($request['img_chan2'])) {
			 		$file3 = Imageresize::CreateCostumeFrontend3($request->img_chan2);
	            	...
	            	foreach ($request['files'] as $file4) {
	...
	/*
		...
		*/
			...
			*/
			...
			'dynamic_percent'=>$req['charity_amount'],
			'updated_at'=>date('y-m-d H:i:s'),
			);
	...
	*/
    ...
    public function updateCostume(Request $request){
    	//echo $delete_costume_attributes;die;
